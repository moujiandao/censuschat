...
def test_readme_uses_current_tabs_and_grounding_claim():
    ...
    assert "Chat, Evidence, Evals, Design Trade-Offs, and How It Works" in text
...
def test_claude_preserves_invariant_11_and_documents_current_system_after_rules():
    ...
    assert "Chat, Evidence, Evals, Design Trade-Offs, and" in current
    assert "How It Works" in current
